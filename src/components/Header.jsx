...
export const Header = () => {
  ...
  const notActiveClass = "block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
  ...
  return (
    <header>
      <nav className="bg-white border-gray-200 dark:bg-gray-900  mx-8 rounded-xl">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="/" className="flex items-center">
            <img src={Logo} className="h-12 mr-3" alt="cinehub Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white sm:text-2xl">Cine<span className="orangeSpan">Hub</span></span>
          </Link>

          <div className="flex md:order-2 sm:">
            <button className="text-gray-500 dark:text-gray-400" onClick={() => (setDarkMode(!darkMode))}>
              <span className="p-2 m-2">Mode</span>
            </button>
